    ...
    create or replace table `marketing-analytics-dbt-497908`.`marketing_dev_marts`.`mart_customer_journey`
    ...
    select *
    from `marketing-analytics-dbt-497908`.`marketing_dev_staging`.`stg_customers`
...
customer_orders as (
    ...
    select *
    from `marketing-analytics-dbt-497908`.`marketing_dev_intermediate`.`int_customers_orders`
...
customer_sessions as (
    ...
    select *
    from `marketing-analytics-dbt-497908`.`marketing_dev_intermediate`.`int_customers_sessions`
