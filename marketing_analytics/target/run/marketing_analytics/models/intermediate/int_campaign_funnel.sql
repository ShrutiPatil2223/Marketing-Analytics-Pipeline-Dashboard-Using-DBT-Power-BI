    ...
    create or replace table `marketing-analytics-dbt-497908`.`marketing_dev_intermediate`.`int_campaign_funnel`
    ...
    select * from `marketing-analytics-dbt-497908`.`marketing_dev_staging`.`stg_campaigns`
