  ...
  create or replace view `marketing-analytics-dbt-497908`.`marketing_dev_staging`.`stg_sessions`
  OPTIONS()
  as with source AS (
    
    SELECT * FROM `marketing-analytics-dbt-497908`.`marketing_raw`.`sessions`
